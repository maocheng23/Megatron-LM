            ...
            for dtype, gbuf_range_map_for_all_buckets in gbuf_range_map.items():
                for gbuf_range_map in gbuf_range_map_for_all_buckets:
                    for param in gbuf_range_map["param_map"]:
                        # Skip parameters not in optimizer param groups (can happen when
                        # ONLY_UPDATE_ENTIRE_LAYER or similar env vars filter which params
                        # are optimized, but grad buffers still contain all params)
