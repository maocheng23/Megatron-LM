...
# TP-invariant matmul kernel: tree-structured K accumulation ensures
# identical results regardless of how K is partitioned across TP ranks.
# Copied from SGLang tp_invariant_ops.py with no modifications.
